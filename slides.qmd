...
![A visualization of the formation of magnetically dominated jets in
  ...
  ](media/mhduet-jetformation.png){height=250}\
...
![Strong scaling plot for the boson star code with 8 fixed mesh refinement
levels on several different systems](media/mhduet-bs-scaling.png)
:::
:::
