...
* Simple structure that is easy to adapt to new problems.
...
* Low number of dependencies
  * Easier to set up/better portability
* Focus on ensuring good performance e.g.:
...
* Training research users how to modify/develop in a GPU-performant way
...
* We currently use FP64 (double precision) everywhere.
* Future GW detectors will need **more** accuracy, not less!
